...
INSERT INTO RESERVATION (USER_ID, PLACE_ID, GUEST_COUNT, STATUS, CHECK_IN, CHECK_OUT, CREATED_AT)
VALUES ('user02', (SELECT MIN(place_id)+8 FROM PLACE WHERE place_type='REST'), 2, 'PENDING', SYSDATE+5, SYSDATE+7, SYSDATE);
...
VALUES ('EARN_LOGIN', 2000, '신규 회윈 가입 시 2000포인트 보상');
