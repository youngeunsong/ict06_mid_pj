...
public class AdAccommodationController {
	...
	@GetMapping("/accommodationSearch.acc") 
	...
	// 관리자 맛집 삭제
	@GetMapping("/accommodationDeleteAction.acc")
	public String accommodationDeleteAction(HttpServletRequest request, Model model) 
	        throws ServletException, IOException {
	    logger.info("<<< url => /accommodationDeleteAction.acc >>>");
	    ...
	    if (keyword != null && !keyword.trim().isEmpty()) {
	        ...
	        return "redirect:/accommodationSearch.acc?pageNum=" + pageNum 
	             + "&areaCode=" + areaCode 
	             + "&category=" + category 
	        ...
	        return "redirect:/accommodation.acc?pageNum=" + pageNum 
	             + "&areaCode=" + areaCode; 
	    }
	}
	//-----------------------------------------------------------------------------------------------------------------
