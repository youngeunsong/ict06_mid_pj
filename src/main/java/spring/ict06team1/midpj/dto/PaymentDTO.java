...
public class PaymentDTO {
	...
	private Timestamp payUpdateDate;
	...
	public PaymentDTO(String payment_id, String user_id, String reservation_id, int amount, String payment_method,
			String payment_status, Timestamp payDate, Timestamp payUpdateDate) {
		super();
	...
	public Timestamp getPayUpdateDate() {
		return payUpdateDate;
	}

	public void setPayUpdateDate(Timestamp payUpdateDate) {
		this.payUpdateDate = payUpdateDate;
	}
	...
	public String toString() {
		return "PaymentDTO [payment_id=" + payment_id + ", user_id=" + user_id + ", reservation_id=" + reservation_id
				...
				+ ", payDate=" + payDate + ", payUpdateDate=" + payUpdateDate + "]";
	}
