                ...
                <div class="container-fluid">
                    <div class="card shadow-sm mx-2">
                        ...
                        <form action="${path}/accommodationModifyAction.adac" method="post" enctype="multipart/form-data" name="updateForm">
                            ...
                            <%-- 1. "-"를 기준으로 주소를 배열로 쪼깨기 --%>
                            	<c:set var="addrArray" value="${fn:split(pDto.address, '-')}" />
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <label class="form-label">숙소 번호</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="숙소" readonly required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="address_detail" name="address_detail" class="form-control" placeholder="상세 주소를 입력하세요~~~" value="${fn:length(addrArray) > 1 ? fn:trim(addrArray[1]) : ''}" required>
                                    ...
                                    <div class="col-md-6">
									    ...
									    <input type="number" name="price" class="form-control" value="${aDto.price}">
									</div>
                            ...
                            <div class="card-footer bg-white border-top-0 py-4 text-center">
                                ...
                                <button type="button" class="btn-cancel shadow-sm" onclick="history.back()">돌아가기</button>
                            </div>
                        </form>
                    </div>
                </div>
