	                ...
	                <div class="card-body">
	                	...
	                	<table class="table">
		                	...
		                	<tr>
	                			...
	                			<td><input type="number" class="form-control" step="0.00000001" name="longitude" id="inputLongitude" placeholder="축제 경도를 입력해주세요" required></td>
	                		</tr>
		                	<!-- 축제 경도 끝-->
		                	<!-- 축제 이미지 URL 시작 -->
		                	<tr>
		                	...
		                	<tr>
	                			...
	                			<td><textarea id="inputDescription" class="form-control" name="description" cols="50" rows="10" placeholder="축제에 대한 설명문을 입력해주세요." required></textarea></td>
	                		</tr>
		                	<!-- 축제 설명 끝 -->
		                	<!-- 축제 시작일 시작 -->
		                	<tr>
			                			...
			                			<tr>
			                				...
			                				<td>
			                					<div class="d-flex align-items-center">
			                						<input type="number" class="form-control w-75 mr-2" name="priceFree" placeholder="가격" >
												  	<span>원</span>
												</div>
			                				</td>
			                				<td><input type="number" class="form-control" name="stockFree" placeholder="재고" ></td>
			                				<td><textarea name="ticketDescFreeDay" class="form-control" placeholder="티켓 설명문을 입력해주세요."></textarea></td>
			                			</tr>
			                			<!-- 무료 티켓 끝 -->
			                			<!-- 1일권 시작 -->
			                			<tr>
			                				...
			                				<td>
			                					<div class="d-flex align-items-center">
			                						<input type="number" class="form-control w-75 mr-2" name="priceOneDay" placeholder="가격" >
												  	<span>원</span>
												</div>
			                				</td>
			                				<td><input type="number" class="form-control" name="stockOneDay" placeholder="재고" ></td>
			                				<td><textarea name="ticketDescOneDay" class="form-control" placeholder="티켓 설명문을 입력해주세요."></textarea></td>
			                			</tr>
			                			<!-- 1일권 끝 -->
			                			<!-- 2일권 시작 -->
			                			<tr>
			                				...
			                				<td>
			                					<div class="d-flex align-items-center">
			                						<input type="number" class="form-control w-75 mr-2" name="priceTwoDay" placeholder="가격" >
												  	<span>원</span>
												</div>
			                				</td>
			                				<td><input type="number" class="form-control" name="stockTwoDay" placeholder="재고" ></td>
			                				<td><textarea name="ticketDescTwoDay" class="form-control" placeholder="티켓 설명문을 입력해주세요."></textarea></td>
			                			</tr>
			                			<!-- 2일권 끝 -->
			                			<!-- 전일권 시작 -->
			                			<tr>
			                				...
			                				<td>
			                					<div class="d-flex align-items-center">
			                						<input type="number" class="form-control w-75 mr-2" name="priceAllDay" placeholder="가격" >
												  	<span>원</span>
												</div>
			                				</td>
			                				<td><input type="number" class="form-control" name="stockAllDay" placeholder="재고" ></td>
			                				<td><textarea name="ticketDescAllDay" class="form-control" placeholder="티켓 설명문을 입력해주세요."></textarea></td>
			                			</tr>
			                			<!-- 전일권 끝 -->
				                	</table>
				                	<!-- 티켓 표 끝 -->
