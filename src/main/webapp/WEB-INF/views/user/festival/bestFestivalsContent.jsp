...
<section class="rk-section">
  ...
  <div class="rk-sectionSub">현재 평점이 가장 높은 축제</div>
  <div class="rk-topWrap">
    ...
    <c:forEach var="item" items="${topList}" begin="0" end="0">
      <div class="rk-top1 mb-4">
        ...
        <jsp:include page="/WEB-INF/views/common/card/BigFestCard.jsp"/> <%-- 공통 카드 컴포넌트 재사용 --%>
      </div>
    </c:forEach>
    ...
    <div class="row g-4">
      <c:forEach var="item" items="${topList}" begin="1" end="4" varStatus="st">
        <div class="col-12 col-md-6 rk-topSub">
          ...
          <jsp:include page="/WEB-INF/views/common/card/BigFestCard.jsp"/>
        </div>
      </c:forEach>
    </div>
