    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
      <div>
        <div class="d-flex flex-wrap align-items-center gap-2">
          ...
          <span class="r-pill">${festival.placeDTO.place_type}</span>
          <span class="r-pill">${festival.placeDTO.address}</span>
        </div>
        ...
        <div class="d-flex flex-wrap align-items-center gap-2 mt-2 r-muted">
          <div class="d-flex align-items-center gap-2 r-stars">
			  ...
			  <span class="r-score">
			    <fmt:formatNumber value="${festival.placeDTO.avg_rating}" pattern="0.0"/>
			  </span>
			  <span>(${festival.placeDTO.review_count}개)</span>
			</div>
          <span>·</span>
          <span>${festival.placeDTO.address}</span>
        </div>
      </div>
    ...
    <div class="row g-4">
	  ...
	  <div class="col-lg-4">
        <div class="r-sticky d-flex flex-column gap-3">
          ...
          <div class="card shadow-sm border-0" style="border-radius:18px;">
            <div class="card-body">
              <div class="fw-bold fs-5 mb-2">이 축제 북마크하기</div>
