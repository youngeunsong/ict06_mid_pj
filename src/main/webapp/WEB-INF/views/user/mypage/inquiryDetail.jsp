...
<link rel="stylesheet"
	href="${path}/resources/css/user/mypage/inquiryDetail.css">
</head>
<body>
	<div class="wrap">
					...
					<div class="detail-card">
						<div class="detail-top">
							...
							<div class="detail-meta">
								<span class="meta-box"> 작성자 ${dto.user_id} </span> <span
									class="meta-box"> 작성일 <fmt:formatDate
										value="${dto.inquiryDate}" pattern="yyyy-MM-dd HH:mm" />
								</span> <span
									class="badge-status ${dto.status eq 'ANSWERED' ? 'badge-done' : 'badge-waiting'}">
									${dto.status eq 'ANSWERED' ? '답변 완료' : '답변 대기'} </span>
							</div>
						</div>
						...
						<div class="detail-body">
							...
							<c:choose>
								<c:when
									test="${dto.status eq 'ANSWERED' and not empty dto.admin_reply}">
									<div class="answer-card">
										<div class="answer-header">
											...
											<div class="answer-date">
												답변일 :
												<fmt:formatDate value="${dto.answerDate}"
								...
								<c:otherwise>
									<div class="waiting-box">
										...
										<p>
											현재 문의를 확인 중입니다.<br> 답변이 등록되면 이 영역에 관리자 답변이 표시됩니다.
										</p>
									</div>
								</c:otherwise>
							</c:choose>
