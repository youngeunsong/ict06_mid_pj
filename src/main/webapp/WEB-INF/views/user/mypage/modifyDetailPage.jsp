...
<body class="bg-light">
							...
							<form action="${path}/modifyUserAction.do" method="post"
								...
								<table class="table table-bordered align-middle">
									<tr>
										...
										<td><span class="fw-bold px-2">${dto.user_id}</span> <input
											type="hidden" name="user_id" value="${dto.user_id}">
										</td>
									</tr>
									<tr>
										<th class="table-label text-center">포인트</th>
										<td><span class="text-success fw-bold px-2"> <i
												class="bi bi-cash"></i> ${dto.point_balance != null ? dto.point_balance : 0}
												P
										</span></td>
									</tr>
								</table>
								...
								<div class="row g-3">
									...
									<div class="col-md-6">
										<label class="form-label small fw-bold">새 비밀번호 확인</label> <input
											type="password" id="password_confirm" class="form-control"
								...
								<div class="row g-3">
									<div class="col-md-6">
										<label class="form-label small fw-bold">이름</label> <input
											type="text" name="name" value="${dto.name}"
											class="form-control">
									</div>
									<div class="col-md-6">
										<label class="form-label small fw-bold">생년월일</label> <input
											type="date" name="birth_date" value="${dto.birth_date}"
											class="form-control">
									</div>
									<div class="col-md-6">
										<label class="form-label small fw-bold">이메일</label> <input
											type="email" name="email" value="${dto.email}"
											class="form-control">
									</div>
									<div class="col-md-6">
										<label class="form-label small fw-bold">연락처</label> <input
											type="text" name="phone" value="${dto.phone}"
											class="form-control" placeholder="010-0000-0000">
									</div>
									<div class="col-12">
										<label class="form-label small fw-bold">주소</label> <input
											type="text" name="address" value="${dto.address}"
											class="form-control">
									</div>
									<div class="col-12">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender"
												id="genderM" value="M" ${dto.gender == 'M' ? 'checked' : ''}>
											<label class="form-check-label" for="genderM">남성</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender"
												id="genderF" value="F" ${dto.gender == 'F' ? 'checked' : ''}>
								...
								<div class="d-flex justify-content-between align-items-center">
									<button type="button" class="btn btn-outline-danger btn-sm"
										onclick="if(confirm('정말 탈퇴하시겠습니까? 데이터가 모두 삭제됩니다.')) location.href='${path}/deleteUser.do'">
										회원탈퇴</button>
									<div>
										<button type="button" class="btn btn-light px-4 me-2"
											onclick="location.href='${path}/main.do'">취소</button>
										<button type="submit" class="btn btn-point px-5 fw-bold">정보
											수정 완료</button>
									</div>
								</div>
							</form>
	...
	<script src="${path}/resources/js/user/mypage/modifyDetailPage.js"></script>
</body>
</html>