...
<link rel="stylesheet" href="${path}/resources/css/user/mypage/myPageHome.css">
</head>
<body>
				...
				<main class="col-lg-9">
						...
						<div class="col-md-4">
							<div class="card activity_item p-4"
								...
								<div class="icon_box mb-3">
									...
									<span class="badge rounded-pill bg-primary count_badge">${reservationCount}</span>
								</div>
					...
					<div class="row g-3 mb-5">
						<div class="col-md-4">
							<div class="card custom_card">
								<div class="card_img"
									style="background-image: url('https://picsum.photos/id/429/300/200');"></div>
								<div class="card-body p-3">
									<%-- text-truncate: 긴 제목은 ...으로 생략 --%>
									<p class="fw-bold mb-0 text-truncate"
										style="font-size: 1.05rem;">장어의꿈</p>
					...
					<div class="row g-3">
						<div class="col-md-4">
							<div class="card custom_card">
								<div class="card_img"
									style="background-image: url('https://picsum.photos/id/488/300/200');">
									<span class="rank_badge">BEST 1</span>
								</div>
								<div class="card-body p-3">
									<p class="fw-bold mb-0 text-truncate"
										style="font-size: 1.05rem;">속초 중앙시장 닭강정</p>
