...
<link rel="stylesheet"
	href="${path}/resources/css/user/restaurant/restaurant.css">
        ...
        <div class="search-container">
            <div class="search-main-row">
                <div class="search-input-group">
                    <input type="text" id="keywordInput" placeholder="맛집을 검색하세요" onkeyup="if(event.keyCode==13)searchData()">
